...
export default class SurveyPage4Symptom1 extends Component {
  constructor() {
    super();
    this.state = {
      selectedItems: [],
  ...
  handleSymptom = event => {
    const cloneArray = JSON.parse(JSON.stringify(this.props.selectedSymptom1));
        ...
        <QuestionBox>
          <QuestionHeader>
            <QuestionWrapper>
              ...
              <Question>
                {this.props.username}님에게 해당하는 것을 최대 2가지 선택해
                주세요.
              </Question>
            </QuestionWrapper>
            {/* <IconWrapper>
              ...
              return (
                <AnswerBoxItem>
                  <Checkbox
                    ...
                    value={item.id}
                    checked={
                      this.props.selectedSymptom1.indexOf(item.id) !== -1
                    }
