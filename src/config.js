...
const HYUNSOO_BASE_URL = 'http://10.58.2.22:8000';

export const SIGN_UP_API = `${HYUNSOO_BASE_URL}/users/signup`;
export const KAKAO_SIGN_IN_API = `${YOUNGSOO_BASE_URL}/users/kakaologin`;
export const SIGN_IN_API = `${HYUNSOO_BASE_URL}/users/login`;
...
export const SURVEY_RESULT_DETAIL_API = `${HYUNSOO_BASE_URL}/survey/result?survey-id=1`;
export const DETAIL_API = `${HYUNSOO_BASE_URL}/product/detail?id=`;
